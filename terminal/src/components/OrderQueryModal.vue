...
.oqm__field--date :deep(.date-picker) {
  width: auto;
}
.oqm__field--date :deep(.date-picker__trigger) {
  flex-direction: row;
  gap: 8px;
  width: auto;
  height: 40px;
...
.oqm__field--date :deep(.date-picker__trigger svg) {
  width: 18px;
  height: 18px;
  flex-shrink: 0;
}
.oqm__field--date :deep(.date-picker__trigger-md) {
  font-size: var(--fs-base);
}
